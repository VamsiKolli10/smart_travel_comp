        ...
        {[1,2,3].map(i => (
          <article key={i} className="accommodation-card">
            ...
            <div className="accommodation-content">
              ...
              <div className="accommodation-location"><i className="fa-solid fa-location-dot"></i> Boston, MA</div>
              ...
              <div className="safety-rating"><i className="fa-solid fa-shield-heart"></i> Safe area</div>
            </div>
          </article>
        ))}
      </div>
